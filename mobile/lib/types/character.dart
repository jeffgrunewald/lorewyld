...
class CharacterSheet {
  ...
  // initiative, passive perception) now lives in the shared Rust core
  // (`lorewyld-domain`), reached over FFI via `ffi/api/sheet.dart`. This
  // keeps a single, tested implementation across mobile and web.
