/* @ts-self-types="./lorewyld_domain.d.ts" */
 ...
 * @returns {number}
 */
export function ability_modifier(score) {
    const ret = wasm.ability_modifier(score);
    return ret;
}
 ...
 * @returns {number}
 */
export function proficiency_bonus(level) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lorewyld_domain_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
